...
function Icon({ name, size = 18, stroke = 1.7 }) {
    ...
    switch (name) {
        case "overview":
            ...
            break;
        case "analytics":
            content = <><path d="M4 19V9h4v10M10 19V4h4v15M16 19v-7h4v7"/><path d="M2 21h20"/></>;
            break;
        case "redeem":
            content = <><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 7h8M8 11h3M8 15h8"/><circle cx="16" cy="11" r="1.5"/></>;
            break;
        case "transactions":
            content = <><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 9h18M7 14h3"/></>;
            break;
        case "spots":
            content = <><path d="M12 3 14.4 8l5.6.7-4.1 3.9 1.1 5.5L12 15.5 7 18.1l1.1-5.5L4 8.7 9.6 8 12 3Z"/><circle cx="12" cy="10" r="1.1"/></>;
            break;
        case "product":
            content = <><path d="m4 8 8-4 8 4-8 4-8-4Z"/><path d="m4 12 8 4 8-4M4 16l8 4 8-4"/></>;
            break;
        case "event":
            content = <><path d="M3 7h18v13H3zM7 4v6M17 4v6M3 11h18"/></>;
            break;
        case "catalog":
            content = <><path d="M4 5h16v14H4zM4 9h16M8 5v14"/><path d="M12 13h5M12 16h3"/></>;
            break;
        case "categories":
            content = <><rect x="3" y="3" width="8" height="8" rx="1"/><rect x="13" y="3" width="8" height="8" rx="1"/><rect x="3" y="13" width="8" height="8" rx="1"/><rect x="13" y="13" width="8" height="8" rx="1"/></>;
            break;
        case "members":
            content = <><circle cx="9" cy="8" r="3"/><path d="M3 20c.6-3.2 2.7-5 6-5s5.4 1.8 6 5M17 12a2.6 2.6 0 0 0 0-5M17 15c2.3.2 3.6 1.6 4 4"/></>;
            break;
        case "appearance":
            content = <><path d="m14 4 6 6M4 20l3.6-.8L19 7.8a2.1 2.1 0 0 0-3-3L4.6 16.2 4 20Z"/><path d="m13 5 6 6"/></>;
            break;
        case "permission":
            content = <><path d="M5 3h14v18H5zM8 7h8M8 11h8M8 15h5"/><path d="m16 18 2 2 3-4"/></>;
            break;
        case "support":
            content = <><circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.7 2.7 0 1 1 4.5 2c-1.2.9-2 1.3-2 2.7M12 17h.01"/></>;
            break;
        case "report":
            content = <><path d="M5 21V4M5 5h13l-2.4 3L18 11H5"/></>;
            break;
        case "feedback":
            content = <><path d="M4 5h16v11H8l-4 4V5Z"/><path d="M8 9h8M8 12h5"/></>;
            break;
        case "collapse":
            content = <><rect x="3" y="4" width="18" height="16" rx="1.5"/><path d="M8 4v16M12 10h5M14 8l-2 2 2 2"/></>;
            break;
        case "document":
            content = <><path d="M6 3h8l4 4v14H6zM14 3v5h5M10 13h5M10 17h5"/><path d="M10 9h1"/></>;
            break;
        case "settings":
            content = <><circle cx="12" cy="12" r="3"/><path d="m19.4 15 .1.1-1.8 3.1-.2-.1a2.1 2.1 0 0 0-2.6.4l-.1.2h-3.6l-.1-.2a2.1 2.1 0 0 0-2.6-.4l-.2.1-1.8-3.1.1-.1a2.1 2.1 0 0 0 0-3l-.1-.1 1.8-3.1.2.1a2.1 2.1 0 0 0 2.6-.4l.1-.2h3.6l.1.2a2.1 2.1 0 0 0 2.6.4l.2-.1 1.8 3.1-.1.1a2.1 2.1 0 0 0 0 3Z"/></>;
            break;
        case "download":
            content = <><path d="M12 3v11M8 10l4 4 4-4M5 18v3h14v-3"/></>;
            break;
        case "refresh":
            content = <><path d="M20 11a8 8 0 0 0-14.8-3.9L3 10M3 5v5h5M4 13a8 8 0 0 0 14.8 3.9L21 14m0 5v-5h-5"/></>;
            break;
        case "chart":
            content = <><path d="M4 17c2-7 5-8 7-3s4 4 9-5"/><circle cx="4" cy="17" r="1.2"/><circle cx="20" cy="9" r="1.2"/></>;
            break;
        case "table":
            content = <><rect x="3" y="4" width="18" height="16" rx="1"/><path d="M3 9h18M3 14h18M9 9v11M15 9v11"/></>;
            break;
        case "card":
            content = <><rect x="3" y="5" width="18" height="14" rx="1"/><path d="M3 9h18M7 14h4"/></>;
            break;
        case "search":
            content = <><circle cx="10.8" cy="10.8" r="6.3"/><path d="m16 16 4.5 4.5"/></>;
            break;
        case "calendar":
            content = <><rect x="3" y="4.5" width="18" height="16" rx="2"/><path d="M7 2.8v4M17 2.8v4M3 9h18"/></>;
            break;
        case "chevron":
            content = <path d="m8 10 4 4 4-4"/>;
            break;
        case "sort":
            content = <path d="m8 9 4-4 4 4M16 15l-4 4-4-4"/>;
            break;
        case "more":
            ...
            break;
        case "basic":
            content = <><path d="M4 18c.3-4.8 2.9-7.2 8-7.2s7.7 2.4 8 7.2"/><circle cx="12" cy="7" r="3"/></>;
            break;
        case "verified":
            content = <><path d="m12 3 2 1.3 2.4-.1 1.1 2.2 2 1.3-.6 2.3.6 2.3-2 1.3-1.1 2.2-2.4-.1-2 1.3-2-1.3-2.4.1-1.1-2.2-2-1.3.6-2.3L4 7.7l2-1.3 1.1-2.2 2.4.1L12 3Z"/><path d="m9 10.5 2 2 4-4"/></>;
            break;
        case "platinum":
            content = <><path d="m12 3 2.2 5.1 5.5.5-4.2 3.6 1.3 5.4-4.8-2.9-4.8 2.9 1.3-5.4-4.2-3.6 5.5-.5L12 3Z"/><path d="M7 21h10"/></>;
            break;
        case "menu":
...
const systemNav = [{ label: "Appearance", icon: "appearance" }, { label: "Permission", icon: "permission" }];
...
function FilterField({ label, children }) { return <label className="filter-field"><span>{label}</span>{children}</label>; }
export default function App() {
    ...
    const updateFilter = (key, value) => setPendingFilters((current) => ({ ...current, [key]: value }));
    const exportRows = () => {
        ...
        link.href = url;
        link.download = "user-redeem-list.csv";
        link.click();
        URL.revokeObjectURL(url);
        showToast("Redeem list exported");
    };
    const renderNavigation = (items) => items.map((item) => <SidebarItem key={item.label} item={item} active={activeNav === item.label} onSelect={() => { setActiveNav(item.label); setMobileNavOpen(false); }}/>);
